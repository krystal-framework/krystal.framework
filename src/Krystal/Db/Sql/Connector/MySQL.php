...
final class MySQL implements ConnectorInterface
{
    ...
    public function getArgs(array $config)
    {
        ...
        return array($dsn, $config['username'], $config['password'], array(
            ...
            // Disable STRICT mode
            PDO::MYSQL_ATTR_INIT_COMMAND => 'SET sql_mode="IGNORE_SPACE,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION"'
        ));
    }
}
